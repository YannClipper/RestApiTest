...
console.log('🚀 Starting YannClipper API Server...');
...
<div class="container">
<div class="header">
<h1>YannClipper API</h1>
<p>Simple, Clean & Powerfull API System</p>
</div>
...
res.json({
success: true,
message: 'YannClipper - Simple & Clean API System',
creator: 'YannClipper',
version: '1.0.0',
features: [
...
console.log(`🚀 YannClipper API running on http://0.0.0.0:${PORT}`);
