...
async register() {
try {
const yann = await axios.post('https://www.kimi.com/api/device/register', {}, {
headers: this.headers
});

return {
auth: `Bearer ${yann.data.access_token}`,
cookie: yann.headers['set-cookie'].join('; ')
};
} catch (error) {
